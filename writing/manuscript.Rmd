...
In the rest of this paper, we report a study of the ability to discriminate melodies, detect mistuned singing, and detect misaligned beats, in `r f(users$final)` people across the globe. Participants self-reported their native language, location, demographics, and degree of musical training, enabling language-wise and language-type-wise analyses of each of these musical abilities and their relations to linguistic and musical experience.
